...
export function Hero() {
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-cyan-50 via-teal-50 to-emerald-50 overflow-hidden">
      {/* Animated Background */}
      <div className="absolute inset-0">
        <div className="absolute inset-0 bg-gradient-to-r from-cyan-200/30 via-teal-200/40 to-emerald-200/30"></div>
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_left,rgba(103,232,249,0.4),transparent_50%)]"></div>
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_right,rgba(45,212,191,0.4),transparent_50%)]"></div>
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(167,243,208,0.3),transparent_70%)]"></div>
        
        {/* Animated particles */}
        <div className="absolute top-20 left-20 w-2 h-2 bg-cyan-300/50 rounded-full animate-ping"></div>
        <div className="absolute top-40 right-32 w-1 h-1 bg-teal-300/60 rounded-full animate-pulse delay-1000"></div>
        <div className="absolute bottom-32 left-40 w-1.5 h-1.5 bg-emerald-300/50 rounded-full animate-ping delay-2000"></div>
        <div className="absolute top-60 right-20 w-1 h-1 bg-cyan-400/60 rounded-full animate-pulse delay-500"></div>
      </div>
      
      <div className="relative container mx-auto px-4 py-24 lg:py-32">
        <div className="max-w-4xl mx-auto text-center">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-cyan-200/30 to-teal-200/30 backdrop-blur-xl border border-cyan-300/40 rounded-full px-6 py-3 mb-8 shadow-2xl">
            <Sparkles className="h-5 w-5 text-amber-400 animate-pulse" />
            <span className="text-sm font-semibold text-cyan-800 tracking-wide">✨ New Collection Available</span>
          </div>
          ...
          <p className="text-xl md:text-2xl mb-16 text-gray-700 max-w-3xl mx-auto leading-relaxed font-light">
            ...
            <span className="font-semibold bg-gradient-to-r from-cyan-500 to-teal-500 bg-clip-text text-transparent"> Quality meets elegance.</span>
          </p>
          
          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-20">
            <Link href="/products">
              <Button size="lg" className="bg-gradient-to-r from-cyan-400 to-teal-400 hover:from-cyan-500 hover:to-teal-500 text-white px-10 py-4 text-lg font-bold shadow-2xl hover:shadow-cyan-500/25 transition-all duration-300 group border-0 rounded-xl">
                Shop Collection
