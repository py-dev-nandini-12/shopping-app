                ...
                <div key={order.id} className="border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow">
                  ...
                  <div className="space-y-3">
                    {order.items.map((item) => (
                      <div key={`${item.id}-${item.size || ''}-${item.color || ''}`} className="flex items-center gap-4 p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-100">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          {order.paymentMethod.type === 'credit' ? 'Credit' : 'Debit'} Card ending in {order.paymentMethod.last4}
                        </p>
                      </div>
                    </div>
                  </div>
